(function () {
  ...
  var isAvailable = /catalog-available(\.html)?(\?|#|$)/.test(path.split('?')[0]);
  ...
  /* ── Unified card renderer — replaces buildAuctionCard + buildOnRoadCard ── */
  function buildCarCard(car) {
    var transit = isAvailable;
    ...
    var km     = car.mileageKm
      ? Number(car.mileageKm).toLocaleString('en-US') + ' km'
      : escHtml(car.mileageRaw || '—');
    var href   = transit
      ? 'car.html#vin='   + encodeURIComponent(car.vin || '')
      : 'car.html#lotId=' + encodeURIComponent(car.lotId || car.vin || '');
      ...
      '<div class="car-card" style="cursor:pointer" onclick="location.href=\'' + href + '\'">' +
        ...
        '<div class="card-body">' +
          ...
          '<div class="card-details">' +
            ...
            '<div class="detail-item"><span class="detail-label">Місце</span><span class="detail-value"><span class="status-dot dot-ok"></span>' + escHtml(car.location || defaultLoc) + '</span></div>' +
